...
=item B<--error-handler=>I<función>

Invoca dicha función de la shell si la ejecución del script de init falla. La
función debe proporcionarse en los scripts prerm y postinst, antes del símbolo
#DEBHELPER#.
