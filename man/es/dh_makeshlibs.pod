...
la parte debian del número de versión del paquete. Si se especifica «-V» 
con parámetros, los parámetros pueden ser usados para especificar la 
...
compartidas de otros paquetes son al menos lo más pequeñas que necesitan
ser (a menos que su biblioteca sea propensa a cambiar el ABI sin actualizar
el número de versión del desarrollador principal), de modo que si el 
desarrollador las malogra éstas no se romperán.
